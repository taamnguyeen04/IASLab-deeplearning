...
def get_args():
    ...
    parser.add_argument("--saved_checkpoint", "-o", type=str, default="trained_models_fasterrcnn/best.pt", help="Load from this checkpoint")
...
def test(args):
    ...
    checkpoint = torch.load(args.saved_checkpoint, map_location="cpu", weights_only=True)
