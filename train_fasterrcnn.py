import os
import numpy as np
from dataset import VOCDatasetDetection
import argparse
import torch
...
def get_args():
    ...
    parser.add_argument("--checkpoint_folder", "-c", type=str, default="trained_models_fasterrcnn",
...
def train(args):
    ...
    train_dataset = VOCDatasetDetection(root=args.data_path, year=args.year, image_set="train", download=False,
    ...
    val_dataset = VOCDatasetDetection(root=args.data_path, year=args.year, image_set="val", download=False,
                             transform=ToTensor())
